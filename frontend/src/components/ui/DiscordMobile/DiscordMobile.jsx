...
export default async function DiscordMobile() {
    const data = await getData('http://localhost:1995/discord')
    const serveChikitaverse = data.serveData

    return (
        <nav className={styles.dcmobile}>
            <header>
            ...
            <p>Online: {compactNotation(serveChikitaverse.presence_count)}</p>
                <a href={serveChikitaverse.instant_invite} target="_blank">
