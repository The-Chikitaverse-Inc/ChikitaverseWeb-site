...
export default async function DiscordList() {
    ...
    return (
        <nav className={` ${styles.dclist} textcolor`}>
            ...
            <span>
                <h6>Chikitaverse</h6>
                    <p>Online:{compactNotation(serveChikitaverse ? serveChikitaverse.presence_count : 'None')}</p>
                        <a href={serveChikitaverse ? serveChikitaverse.instant_invite : null} target="_blank">
